...
break
case 'بوت': case 'panel': case 'list': case 'menu': case 'help': case '?': {
		if (isBan) return reply(mess.ban)	 			
if (isBanChat) return reply(mess.banChat)
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
            ...
            { quickReplyButton: { displayText: `القايمة`, id: 'allmenu'} },
            { quickReplyButton: { displayText: `قائمة 🍢`, id: 'command'} },
            { quickReplyButton: { displayText: `مطور`, id: 'owner'} }
        	]
							...
							},
							{
								...
								"rows": [
									     ...
									     },
									{
										...
										{
											"title": "تحويل القائمة ⚒️",
										"description": "Displays The List Of Convert Features",
										"rowId": `${prefix}convertmenu`
										},
										{
											"title": "قائمة قاعدة البيانات ♻️",
...
case 'allmenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
var unicorn = await getBuffer(picak+'القايمة')
await XeonBotInc.send5ButImg(from, `╔═══════✪「 مطور اسكوديا 」	
╠ ${prefix}الذات
╠ ${prefix}عام
╠ ${prefix}antitag
...
╠${prefix}ازاله من رول [ريبلاي/منشن]
...
await XeonBotInc.send5ButImg(from, `╔═══════✪「 تحويل 」	
╠ ${prefix}toimage [reply stick]
╠ ${prefix}sticker [reply img|gif]
...
╠ ${prefix}emoji [emoji]
╠ ${prefix}tovideo [reply img]
╠ ${prefix}تحويل استيكر [reply stick]
╠ ${prefix}tourl [reply img]
╠ ${prefix}tovn [reply aud]
╠ ${prefix}tomp3 [reply vn]
╠ ${prefix}toaudio [reply vid]
